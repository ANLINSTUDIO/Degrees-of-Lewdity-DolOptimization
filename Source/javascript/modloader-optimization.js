...
window.dolOptSaveIndexDBModList = async function(enabledList, disabledList) {
    const targetEnabled = window.dolOptUniqueModNames(enabledList);
...
window.dolOptCaptureLogScreenshot = async function() {
    ...
    ctx.fillText('由 原版优化模组 (Dol-Optimization) 自动生成 · 支持直接在贴吧 / 交流群 Ctrl+V 粘贴', padding + 16, totalHeight - 14);
